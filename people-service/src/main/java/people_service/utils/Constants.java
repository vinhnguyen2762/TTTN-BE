...
public class Constants {
    ...
    public final class ErrorMessage {
        ...
        public static final String TOKEN_NOT_FOUND_ID = "Token of small trader with id: %s not found";
        ...
        public static final String SMALL_TRADER_NOT_FOUND_EMAIL = "SmallTrader with email: %s not found";
