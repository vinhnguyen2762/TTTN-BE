...
public class ProductController {
    ...
    public ResponseEntity<Long> updateProduct(@PathVariable Long id, @RequestBody ProductAddDto productAddDto) {
        Long rs = productService.updateProduct(id, productAddDto);
